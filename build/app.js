...
/******/ 	var hotCurrentHash = "f34f3d7f0ef13182262a"; // eslint-disable-line no-unused-vars
...
var app4 = new _vue2.default({
  el: '#app-4',
  data: {
    todos: [{ text: 'Create Project11' }, { text: 'Add packages' }, { text: 'Build everything' }, { text: 'Have fun learning' }]
  }
});
